...
export class GraphDescription {
  ...
  showText() {
    ...
    makeLine('U', 'Vertex (or node) attributes', 'e.g., producer', () => this.highlightNodes())
    makeLine('E', 'Edge (or link) weighted transactions', 'e.g., edge weight', () => this.highlightEdges())
    makeLine('G', 'Global attributes', 'e.g., number of nodes', () => this.highlightGlobal())
  }
  highlightEdges() {
